...
async function main() {
  ...
  await prisma.goal.create({
    data: {
      ...
      description: 'Ship one AI-powered feature or prototype that improves workflow efficiency or UX.',
      ...
      actions: {
        create: [
          ...
          { text: 'Validate one idea with stakeholder feedback', isComplete: false },
  ...
  await prisma.goal.create({
    data: {
      ...
      description: 'Establish and document 3 high-impact UI/UX patterns in the design system and refactor key flows to adopt them.',
      ...
      actions: {
        create: [
          { text: 'Audit current patterns across workflows', isComplete: false },
          { text: 'Identify pattern gaps (Layout, Cards, Iconography)', isComplete: true },
          { text: 'Collaborate with product design on conventions', isComplete: false },
  ...
  await prisma.goal.create({
    data: {
      ...
      description: 'Ensure 100% of new features meet WCAG 2.2 AA and establish accessibility best practices.',
      ...
      actions: {
        create: [
          { text: 'Complete accessibility training or cert', isComplete: false },
          { text: 'Create automation tools for verification', isComplete: false },
          { text: 'Partner with QE to add accessibility reviews', isComplete: false },
